...
# Comment.create!(text: 'Well Done :clap::clap::clap:', author: 1, post: 1)
# Comment.create!(text: 'Great post man :clap::clap::clap:', author: first_user.id, post: first_post.id)
# Comment.create!(text: 'I like this post :heavy_check_mark::heavy_check_mark:', author: second_user.id, post: first_post.id)
# Comment.create!(text: 'Well Done :clap::clap::clap:', author: first_user.id, post: first_post.id)
# Comment.create!(text: 'Great post man :clap::clap::clap:', author: first_user.id, post: first_post.id)
# Comment.create!(text: 'I like this post :heavy_check_mark::heavy_check_mark:', author: second_user.id, post: first_post.id)
# Comment.create!(text: 'Well Done :clap::clap::clap:', author: first_user.id, post: first_post.id)
# Comment.create!(text: 'Great post man :clap::clap::clap:', author: first_user.id, post: first_post.id)
